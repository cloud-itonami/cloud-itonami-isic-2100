# Operator Quickstart — Community Pharmaceutical Manufacturing

Shortest path from clone to a verified local dry-run for **ISIC 2100** (`cloud-itonami-isic-2100`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2100.git
cd cloud-itonami-isic-2100
```
...
- Blueprint governor key: `pharma-manufacturing-governor`
- Likely source path: `pharma.governor.cljc`
